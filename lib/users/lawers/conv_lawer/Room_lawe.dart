...
// This function is called when the app launches for the first time or when an image is uploaded or deleted
  ...
  final _loginForm = GlobalKey<FormState>(); TextEditingController post = TextEditingController();
  ...
  getSharedData() async {
    ...
    setState(() {
      ...
      threadId=email.toString().split('@')[0]+widget.laweremail.toString().split('@')[0];
      print(threadId);
    });
  }
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold( appBar: AppBar(
      ...
      body: SizedBox(height: MediaQuery.of(context).size.height-150,
                ...
                return
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      title: Column(
                        crossAxisAlignment: snapshot.data.docs[index]['user']=='client'? CrossAxisAlignment.start:CrossAxisAlignment.end,
                        children: [
                          //image==null?Container():  Image.network('gs://lawer-8613e.appspot.com/scaled_image_picker3235912250554629774.jpg'),

                          snapshot.data.docs[index]['url']=='url nai'?Container():Container(   decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),color: snapshot.data.docs[index]['user']=='client'?Color(0xff9CC2F4): Color(0xfffeecbb),),
                              height: 205,width: 205,
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Image.network('https://firebasestorage.googleapis.com/v0/b/lawer-8613e.appspot.com/o/${snapshot.data.docs[index]['url']}?alt=media&token=260e6756-d21b-43a6-9391-2270ff39f3f2',height: 200,width: 200,),
                              ))
                          ,                       snapshot.data.docs[index]['message']=='image'?Container():   Container(
